...
class BMI_component:
    ...
    def get_var_name(self, long_var_name):
        ...
        # ------------------------------------------------------
        # EXAMPLE:
        self._var_name_map = {"model__time_step": "dt"}
    ...
    #   get_grid_attribute()
    # -------------------------------------------------------------------
    def run_model(self, cfg_directory=None, cfg_prefix=None, n_steps=5):
        # --------------------------------------------------
    ...
    #   check_finished()
    # -------------------------------------------------------------------
    def print_time_and_value(
        self, value, var_name="Q_out", units_name="[m^3/s]", interval=2.0, PRINT_INDEX=False
    ):
        # -----------------------------------------
    ...
    #   print_time_and_value()
    # -------------------------------------------------------------------
    def get_run_time_string(self, proc_name="component", sec_digits=4, seconds=None, SILENT=None):
        ### SUB_PROCESS=False)
    ...
    #   get_run_time_string()
    # -------------------------------------------------------------------
    def print_run_time(self, proc_name="component", sec_digits=4, seconds=None, SILENT=None):
        ### SUB_PROCESS=False)
    ...
    #   print_run_time()
    # -------------------------------------------------------------------
    def print_final_report(self, comp_name="BMI component", mode="nondriver"):
        if mode == "nondriver":
    ...
    def read_time_info(self):
        ...
        # ----------------------------------------------------
        dur_units = "minutes"  #######
        duration = time_utils.get_duration(
            time_info.start_date, time_info.start_time, time_info.end_date, time_info.end_time, dur_units
        )
